...
**Rollback of the 2026-08-19 hybrid:** `git checkout 8b68777 -- oem-landing/ CHANGELOG.md CLAUDE.md` then drop untracked `DESIGN-ibm.md`, `DESIGN-bmw.md`, `oem-landing/design/`. Do not do that unless you intend to unpublish the hybrid.
**Publish status** lives in workspace `CLAUDE.md` / `UPLOAD.md` — this file is the token map, not the live/GitHub ledger.
...
- Factory / lab stills on Home and Capabilities are the same cool 16:9 set (`studio-line`, `studio-calibrate`, `studio-chamber`, `studio-drop`). Phone snapshots `prodline_1.jpg`–`prodline_6.jpg` were removed locally 2026-08-20 and from GitHub 2026-09-01.
- **Chrome (2026-08-20):** `.brand` is the wordmark “Unique Scales” only. No SVG/PNG logomark in the nav. Favicon / apple-touch-icon are a black rounded square + white “U”. Official 4-color pinwheel was rejected; `logo-unique-official.png` removed locally 2026-08-21 and from GitHub 2026-09-01.
- **CK869BLE:** kitchen lineup card uses the complete official 3/4 packshot (`kitchen-ck869.jpg`, 1600×957) — full pan, VA color screen, three keys. The 1012×759 crop is retired; live/GitHub caught up 2026-09-01.
