...
**Publish (2026-08-21):** chrome / CSS / JS / `index.html` still byte-match production (text-only “Unique Scales”, `style.css?v=18`, `partials.js?v=12`). Local CK869BLE packshot does **not** — live still has the cropped 1012×759 file. Local git HEAD is warranty `1bb6f82`; do not check that out over `oem-landing/`, and do not roll this tree back to `8b68777` unless you intend to unpublish the hybrid. GitHub’s copy of this TRACE lags until the next upload.  
